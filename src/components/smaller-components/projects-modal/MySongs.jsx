    ...
    return (
      ...
      <div style={{padding: '0 1rem', marginBottom: '2rem', textAlign: 'center', fontStyle: 'italic', marginTop: '1.35rem'}}>
        ...
        <ProjectDiv>
          ...
          <div className='grid-item' >
             <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/652328030&color=%23005bff&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style={{fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap',textOverflow: 'ellipsis', fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: 100}}><a href="https://soundcloud.com/justin-bernard" title="Justin Bernard" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Justin Bernard</a> · <a href="https://soundcloud.com/justin-bernard/sick-beat" title="Sick Beat" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Sick Beat</a></div>
          </div>

          <div className='grid-item' >
            <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1631038107&color=%23005bff&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style={{fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap',textOverflow: 'ellipsis', fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: 100}}><a href="https://soundcloud.com/justin-bernard" title="Justin Bernard" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Justin Bernard</a> · <a href="https://soundcloud.com/justin-bernard/james-song" title="James&#x27; Song" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>James&#x27; Song</a></div>
          </div>
          
          <div className='grid-item' >
            <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/245102461&color=%23005bff&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style={{fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap',textOverflow: 'ellipsis', fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: 100}}><a href="https://soundcloud.com/justin-bernard" title="Justin Bernard" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Justin Bernard</a> · <a href="https://soundcloud.com/justin-bernard/techno-songs" title="Techno Songs" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Techno Songs</a></div>
          </div>
          
          <div className='grid-item' >
            <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/650336603&color=%23005bff&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style={{fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap',textOverflow: 'ellipsis', fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: 100}}><a href="https://soundcloud.com/justin-bernard" title="Justin Bernard" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Justin Bernard</a> · <a href="https://soundcloud.com/justin-bernard/hit-that" title="Hit That" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Hit That</a></div>
          </div>
          
          <div className='grid-item' >
            <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/649976744&color=%23005bff&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style={{fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap',textOverflow: 'ellipsis', fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: 100}}><a href="https://soundcloud.com/justin-bernard" title="Justin Bernard" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Justin Bernard</a> · <a href="https://soundcloud.com/justin-bernard/euphoria" title="Euphoria" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>Euphoria</a></div>
          </div>
