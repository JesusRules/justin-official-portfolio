      ...
      <div style={{padding: '0 1rem', marginBottom: '2rem', textAlign: 'center', fontStyle: 'italic', marginTop: '1.35rem'}}>
        ...
        <ProjectDiv>
          ...
          <div className='grid-item' style={{ gridArea: 'one' }}>
            <img className='' src="/img/projects/other-projects/polished+.jpg" 
                onClick={(e) => handleUrl("https://polished-plus.netlify.app/")}/>
          </div>
          ...
          <div className='grid-item' style={{ gridArea: 'four' }}>
            <img className='' src="/img/projects/other-projects/youtube-clone.jpg" 
                onClick={(e) => handleUrl("https://justins-youtube-clone.netlify.app/")}/>
          </div>
          ...
          <div className='grid-item' style={{ gridArea: 'seven' }}>
            <div className='info left'>
              <h3 onClick={(e) => handleUrl("https://justins-fire-giftr.netlify.app/")}>Fire Giftr</h3>
          ...
          <div className='grid-item' style={{ gridArea: 'eight' }}>
            <img className='' src="/img/projects/other-projects/fire-giftr.jpg" 
                onClick={(e) => handleUrl("https://justins-fire-giftr.netlify.app/")}/>
          </div>
          ...
          <div className='grid-item' style={{ gridArea: 'nine' }}>
            <img className='' src="/img/projects/other-projects/postgres-poc.jpg" 
                onClick={(e) => handleUrl("https://postgres-poc.netlify.app/")}/>
          </div>
          <div className='grid-item' style={{ gridArea: 'ten' }}>
            <div className='info'>
              <h3 onClick={(e) => handleUrl("https://postgres-poc.netlify.app/")}>Proof Of Concept - Postgres Test</h3>
        ...
        {/* ThreeJS Crash Course */}
          <div className='grid-item' style={{ gridArea: 'eleven' }}>
            <div className='info left'>
              <h3 onClick={(e) => handleUrl("https://justins-threejs-crash-course.netlify.app/")}>ThreeJS Crash Course</h3>
          ...
          <div className='grid-item' style={{ gridArea: 'twelve' }}>
            <img className='' src="/img/projects/other-projects/threejs-crash-course.jpg" 
                onClick={(e) => handleUrl("https://justins-threejs-crash-course.netlify.app/")}/>
          </div>

          {/* ThreeJS Portfolio */}
          <div className='grid-item' style={{ gridArea: 'thirteen' }}>
            <img className='' src="/img/projects/other-projects/threejs-portfolio.jpg" 
                onClick={(e) => handleUrl("https://justins-threejs-portfolio-tutorial.netlify.app/")}/>
          </div>
          <div className='grid-item' style={{ gridArea: 'fourteen' }}>
            <div className='info'>
              <h3 onClick={(e) => handleUrl("https://justins-threejs-portfolio-tutorial.netlify.app/")}>ThreeJS Portfolio</h3>
          ...
          <div className='grid-item' style={{ gridArea: 'fifteen' }}>
            <div className='info left'>
              <h3 onClick={(e) => handleUrl("https://justins-parallax-intro.netlify.app/")}>Parallax Tutorial</h3>
          ...
          <div className='grid-item' style={{ gridArea: 'sixteen' }}>
            <img className='' src="/img/projects/other-projects/parallax-image.jpg" 
                onClick={(e) => handleUrl("https://justins-parallax-intro.netlify.app/")}/>
          </div>

          {/* Giftr (Flutter) */}
          <div className='grid-item' style={{ gridArea: 'seventeen' }}>
            <img className='' src="/img/projects/other-projects/giftr-flutter.jpg" 
                onClick={(e) => handleUrl("https://flutter-giftr.netlify.app/#/")}/>
          </div>
          <div className='grid-item' style={{ gridArea: 'eighteen' }}>
            <div className='info'>
              <h3 onClick={(e) => handleUrl("https://flutter-giftr.netlify.app/#/")}>Giftr (Flutter)</h3>
          ...
          {/* iPhone Website */}
          <div className='grid-item' style={{ gridArea: 'nineteen' }}>
            <div className='info left'>
              <h3 onClick={(e) => handleUrl("https://justins-apple-iphone-website.netlify.app/")}>WebGi (Apple Mimic) Tutorial</h3>
              <p>A super cool tutorial that taught me how to use WebGi for 3D scrolling effects! <a href="https://www.youtube.com/watch?v=IyBhFma4H1A" target="_blank">Video link here.</a>
              </p>
            </div>          
          </div>
          <div className='grid-item' style={{ gridArea: 'twenty' }}>
            <img className='' src="/img/projects/other-projects/apple-mimic-site.jpg" 
                onClick={(e) => handleUrl("https://justins-apple-iphone-website.netlify.app/")}/>
          </div>
